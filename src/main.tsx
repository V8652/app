...
import { TempoDevtools } from "tempo-devtools"; // Import TempoDevtools
...
// Network error handling for mobile apps
if ("Capacitor" in window) {
  ...
  // Set up app URL open listener for mobile deep links
  if ((window as any).Capacitor?.isNativePlatform()) {
    ...
    CapApp.addListener("appUrlOpen", (data: { url: string }) => {
      ...
      if (
        data.url.includes("oauth2callback") ||
        ...
        try {
          ...
          if (code) {
            console.log(
              "Found authorization code in deep link:",
              code.substring(0, 5) + "...",
            );
            ...
            for (const part of pathParts) {
              if (part.startsWith("code=")) {
                ...
                console.log(
                  "Found code in URL path part:",
                  pathCode.substring(0, 5) + "...",
                );
            ...
            if (urlParts.length > 1) {
              ...
              console.log(
                "Trying alternate parsing with query string:",
                queryString,
              );
              ...
              if (altCode) {
                console.log(
                  "Found code using alternate parsing method:",
                  altCode.substring(0, 5) + "...",
                );
                ...
                toast({
                  ...
                  description:
                    "Processing authentication with alternate method...",
                });
              } else {
                toast({
                  title: "Authentication Error",
                  description:
                    "Could not find authorization code in redirect. Please try again.",
                  variant: "destructive",
                });
              }
            } else {
